document.body.insertAdjacentHTML('beforeend', `
    <template id="tpl-login">
        ...
        <div class="flex h-full min-h-[80vh] items-center justify-center">
            <div class="w-full max-w-md mx-auto bg-white dark:bg-slate-900 p-10 rounded-3xl shadow-2xl mt-12 border-b-8 border-blue-600 animate-slide-up-fade" style="animation-delay: 1.5s;">
                ...
                <h2 class="text-3xl font-black text-slate-800 dark:text-white">I.S.F.D. y T. N° 57 "JUANA PAULA MANSO" - Chascomús</h2>
                               <p class="text-slate-500 dark:text-slate-400 mt-1">Centro de Estudiantes</p>
                               <p class="text-slate-500 dark:text-slate-400 mt-2">Ingresa para ver tus datos privados</p>
            </div>
